...
<div id="myModal" class="modal">
    <div class="modal-content">
        ...
        <img src="/images/end4.jpg" alt="Warning" class="modal-image">
        <h3>成功人士！</h3>
        <p>你的成功，不是一蹴而就的辉煌，而是日复一日的坚持和努力。你的生活，充满了简单而真实的幸福。你的事业，虽然没有波澜壮阔，却稳健而持续地发展。成功，不在于外界的评价与物质的优渥，而在于内心的满足。
              （主角转身，面带微笑，手中举着一杯香槟，向镜头举杯。）</p>
        <div>
